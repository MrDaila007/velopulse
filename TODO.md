...
5. Flutter codecs/FakeBleTransport и automatic gate Э5 — выполнены.
6. После hardware gate Э5 начать Э6.
7. Выполнить soak, power и field tests Э7, затем собрать v1.0.
