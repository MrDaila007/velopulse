...
Э2 — базовая прошивка. Энергосбережение OLED bright → dim → off реализовано и
...
- Flash и BLE пока не реализованы.

## Следующий шаг

Реализовать сохранение одометра и настроек во Flash с защитой от износа памяти.
