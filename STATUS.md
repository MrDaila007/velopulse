...
Э2 — базовая прошивка. Постоянная верхняя зона OLED и пять страниц нижней
карусели реализованы в прошивке и общем C++-рендерере симулятора.
...
Загрузить текущую сборку на устройство и визуально подтвердить карусель и постоянную батарею.
