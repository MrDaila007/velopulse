...
Super-nRF52840; реальный уровень Li-Po через внешний делитель P0.31 работает на устройстве.
...
Отключить USB и подтвердить автономную работу от Li-Po с сохранением индикации заряда.
