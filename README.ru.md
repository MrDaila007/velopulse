...
Активная разработка — на ветке **`dev`** (`v0.2.0-beta.3`). Ветка `main` устарела
(только базовая прошивка без BLE и приложения). Подробности: [`STATUS.md`](STATUS.md),
дорожная карта: [`TODO.md`](TODO.md).
